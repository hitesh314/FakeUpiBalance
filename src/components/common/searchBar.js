    ...
    <form className="max-w-full " onSubmit={handleSubmit}>
      ...
      <div className="relative border rounded-3xl">
        ...
        <input
          type="search"
          id="default-search"
          className="block w-80 p-4  rounded-3xl pl-10 text-sm text-gray-900 border border-gray-300  bg-gray-50 
        ...
        <button
          ...
          className="text-white absolute right-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 
                     focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-3xl 
